      ...
      <div className="relative flex flex-col h-full max-w-2xl w-full mx-auto my-0 sm:my-4 sm:rounded-2xl overflow-hidden bg-white shadow-2xl z-10">
        ...
        <div className="flex items-center gap-2 px-4 py-3 bg-white border-b border-gray-100 shrink-0">
          ...
          <a
            ...
            className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 bg-orange-500 hover:bg-orange-600 text-white text-xs font-semibold rounded-full transition-colors"
          >
            Ouvrir ↗
          </a>
        </div>
              ...
              <>
                ...
                <div className="mt-6 pt-4 border-t border-gray-100">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-full transition-colors text-sm"
                  >
